    ...
    while (solutionFound == 0):
        ...
        while solutionFound == 0:
            ...
            for i in range(0, itterations):
                ...
                # TUTAJ SIĘ DZIEJE MAGIA Z WIZUALIZACJĄ
                draw(grid=tmpSudoku.tolist(), score=score, temperatura=sigma)
...
input()  # linijka tylko po to żeby móc podziwiać efekt końcowy
